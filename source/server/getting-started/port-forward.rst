...
Minecraft (and thus Sponge) uses port 25565 by default; however, this can be changed in your :doc:`configuration/server-properties`. UDP and TCP are the protocols that must be forwarded.
