...
#. Install SpongeForge or SpongeVanilla in the folder where you ran your old server, remove the Bukkit or Spigot jars.
   If you're unsure how you're supposed to install SpongeForge or SpongeVanilla properly, read :doc:`this <installation>`.
...
#. Now the migration is performed. At this point, worlds are moved over from what we call the ``world container`` into
...
The guide at :doc:`installation` provides instructions for installing Sponge while
you're migrating.
