...
The abilities of op permission may be adjusted by altering the ``op-permission-level`` setting in the :doc:`../../server/getting-started/configuration/server-properties` file.
