...
If you are stuck or are unsure about certain aspects, go visit the ``#spongedev`` IRC channel, the ``#dev`` channel on Discord,
the forums, or open up an Issue on GitHub. Be sure to check the `Data Processor Implementation Checklist
