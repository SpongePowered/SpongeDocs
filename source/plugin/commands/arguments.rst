...
.. tip::
    ...
    Look at the `source code <https://github.com/SpongePowered/SpongeAPI/blob/stable-5.1.0/src/main/java/org/spongepowered/api/command/args/GenericArguments.java>`_
