...
Before you can start developing your Sponge plugin, you need to set up SpongeAPI dependency in your project. If
...
Version       For example: ``7.0.0`` (stable), or ``8.0.0-SNAPSHOT`` (dev build, unstable)
============= ============================================================================
