...
The event bus is the ``org.spongepowered.api.service.event.EventManager`` class. See :doc:`../../plugin/advanced/services` to learn how to get access to this instance.
